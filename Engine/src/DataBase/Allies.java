...
public class Allies {
    ...
    private String allyName , readyStatus, winner, battlefield,
            uboatUsername, contestDifficulty, messageToDecrpyt, unDecryptedSentence;
    ...
    public String getUnDecryptedSentence() {
        return unDecryptedSentence;
    }

    public void setUnDecryptedSentence(String unDecryptedSentence) {
        this.unDecryptedSentence = unDecryptedSentence;
    }
