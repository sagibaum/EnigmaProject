...
public class UBoat {
    ...
    private String username, messageBeforeUnencrypted;
    ...
    public UBoat(String name) {
        ...
        this.running = false;
        this.alliesJoined = 0;
        messageBeforeUnencrypted="";
        this.uBoatDTO = new UBoatDTO(running);
        this.engine = new EngineObject();
    }

    public String getMessageBeforeUnencrypted() {
        return messageBeforeUnencrypted;
    }

    public void setMessageBeforeUnencrypted(String messageBeforeUnencrypted) {
        this.messageBeforeUnencrypted = messageBeforeUnencrypted;
    }
