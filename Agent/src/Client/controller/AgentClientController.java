...
public class AgentClientController implements Initializable, Closeable {
        ...
        util.http.HttpClientUtil.runAsync(finalUrl, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if (response.code() != 200) {
                    ...
                    if(allyAbandon)
                        showConfirmationAlert("Ally abandon the game/competition! \nReturning to login page...");

                   else showConfirmationAlert("Thank Tou For Playing And See You Soon!!");
                    try {
    ...
    private void createContestVariables() {
        ...
        this.missionPulledNum = 0L;
        this.missionsCompletedNum = 0L;
        AlliesJoinedLabel=AlliesNeededLabel;
